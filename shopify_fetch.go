...
// Updates the fetch url and status
// of the fetch worker
func UpdateFecthStatus(dbconfig *DbConfig, id uuid.UUID, status, fetch_url string) error {
...
// this way the nexxt fetch items can be paginated
