...
SELECT users.id, name, users.email, password, api_key, webhook_token, users.created_at, users.updated_at, google_oauth.id, user_id, cookie_secret, cookie_token, google_id, google_oauth.email, picture, google_oauth.created_at, google_oauth.updated_at FROM users
